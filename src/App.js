...
import iconimg from './assets/img/midas_01.png';
...
function App() {
  ...
  var deadlineGenesis = new Date('2022-04-15 12:00:00').addMinutes(- (new Date().getTimezoneOffset()));
/*   const script = document.createElement("script");
  ...
  return (
    <div className="App" style={{ position: 'relative', minHeight: '100vh' }}>
      ...
      <div style={{ display:'flex',justifyContent: 'space-between',marginRight:'15%' }}>
          <img alt="MIDAS Icon" src={iconimg} className='App-coinlogo' />
{/*           <div style={{ display:'flex',justifyContent: 'space-between' }}>
            <a href="https://doc.midasfi.io" rel="noopener noreferrer" target="_blank" >
                  <img alt="documentation" src={gitbookimg} className="App-gitbooklogo" description="DOCUMENTATION" />
            </a>
            <a href="https://doc.midasfi.io" className="App-doc" target="_blank">DOCUMENTATION</a>
          </div> */}
          <div className="App-event" style={{ textAlign:'center' }}>
            <h5 className="" style={{ marginTop:'5px' }}>Grab FREE tokens</h5>
            <a href='https://gleam.io/JECg2/midas-finance-royal-giveaways'  target="_blank">
              <button class='App-eventbtn'><h5 style={{ lineHeight:1.25,margin:'1px' }}>ROYAL GIVEAWAYS</h5></button>
            </a>  
            <a href='https://gleam.io/M4idW/midas-finance-whitelist'  target="_blank">
      ...
      <body className="App-body">
        ...
        {/* <h1 className='App-title'>MIDAS FINANCE</h1> */}
        <img alt="MIDAS FINANCE" src={logoimg} className='App-logo' />
{/* <div>
<a class="e-widget no-button" href="https://gleam.io/JECg2/midas-finance-royal-giveaways" rel="nofollow">Midas Finance - Royal Giveaways</a>
</div> */}
      </body>
